        ...
        <div className=''>
            ...
            <div className='lg:mt-52 mt-10  lg:flex justify-around lg:ml-[300px] lg:mr-[300px] mr-5  ml-5 '>
                <div className=" text-black">
                    ...
                    <div className='flex gap-8 relative bottom-10'>
                        <button className=" text-[0.8rem] p-1 w-20 rounded-sm text-white bg-orange-500 font-roboto">Hire Me</button>
                ...
                <div>
                    <div
                        ...
                        {/*  image  */}
                        <button className='relative top-8 ml-2 text-black'>Press Here</button>
                        <img
                ...
                <div className='lg:mt-0 mt-6 lg:ml-0 ml-24'>
